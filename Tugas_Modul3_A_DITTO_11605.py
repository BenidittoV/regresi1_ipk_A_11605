...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'> Prediksi IPK - 11605 </h1>", unsafe_allow_html=True)
...
st.sidebar.markdown("<h3 class='header-txt> Upload File dan Input Nilai </h3>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'D:\Ditto\Kuliah\Matkul\Semester 5\ML\Pertemuan 6\Tugas3_A_11605'
    ...
    if os.path.exists(model_path):
        ...
        ind1 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 1.1", 70.0, 99.0)
        ind2 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 1.2", 65.0, 99.0)
        ind3 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 2.1", 68.0, 99.0)
        ...
        input_data = [
            mtk1, mtk2, mtk3, mtk4, ing1, ing2, ing3, ing4, ind1, ind2, ind3, ind4,
